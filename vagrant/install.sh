...
if ! command -v psql; then
    ...
    cp /vagrant/vagrant/install/pg_hba.conf /etc/postgresql/$PGSQL_VERSION/main/
...
sudo -u postgres psql -c "create database sungaelee;"
sudo -u postgres psql -c "create user root with password 'password';"
sudo -u postgres psql -c "grant all privileges on database sungaelee to root;"
